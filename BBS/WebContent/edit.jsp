...
<%
  ...
  if(!userID.equals(board.getUserID())){ //session에 있는 값과 작성자의 ID가 동일한지 확인
      PrintWriter script = response.getWriter();
      script.println("<script>");
...
<thead>
  <tr>
  <th colspan="2" style="background-color: #eeeeee; text-align: center;">Posting Edit</th>
  </tr>
</thead>
<tbody>
<tr>
...
<tr>
<td><textarea class="form-control" placeholder="content" name="boardContent" maxlength="2048" style="height: 350px;"><%=board.getBoardContent() %>"></textarea></td>
<% } %> 
</tr>
</tbody>
</table>
